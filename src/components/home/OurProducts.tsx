...
const OurProducts = () => {
  return (
    ...
    <section className='flex'>
        <div className={`w-full h-[43.5rem] flex flex-col justify-end pb-[0.8rem] items-center relative bg-[url('/assets/images/solar-panel-one.jpeg')]`}>
        ...
        <div className={`w-full h-[43.5rem] flex flex-col justify-end pb-[0.8rem] items-center relative bg-[url('/assets/images/solar-panel-two.jpeg')]`}>
        ...
        <div className={`w-full h-[43.5rem] flex flex-col justify-end pb-[0.8rem] items-center relative bg-[url('/assets/images/solar-panel-three.jpeg')]`}>
            <h3 className='text-white text-[2.2rem] font-semibold leading-[2.42rem]'>Adani Plant - Gujarat</h3>
