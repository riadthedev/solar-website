...
const Welcome = () => {
  return (
    <SectionWrapper classname={`relative bg-[url('/assets/images/welcome-bg.png')] bg-no-repeat bg-contain bg-center min-h-[70rem] flex items-center justify-center`} data-aos='zoom-in-up'>
        <div className="absolute inset-0 bg-black opacity-50 mx-[2rem]"></div>
        <div className='relative flex flex-col justify-center items-center max-w-[100rem] gap-y-[5rem] '>
